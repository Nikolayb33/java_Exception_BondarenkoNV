...
(Если число 6 хорошо, если не 6 то вернуть код ошибки -1 и написать не те данные)
Бондаренко Николай Владимирович 12.05.1993 9150937307 m
...
(у своего номера в листе должен быть свой формат либо должна выбрасываться ошибка)
...
(try catch с условием записи в файл?)
